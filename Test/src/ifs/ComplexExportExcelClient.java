 ...
 * Package ifs 
 * FileName: ComplexExportExcelClient.java
 * Author:   FY
 * Date:     2017年3月22日 下午5:07:09
 * Description: //模块目的、功能描述      
 * History: //修改记录
 *===============================================================================================
 *   author：          time：                             version：           desc：
 *   FY           2017年3月22日下午5:07:09                     1.0                  
 *===============================================================================================
 */
package ifs;
...
public class ComplexExportExcelClient {
    ...
    public static void main(String[] args) {
        ...
        ExportUtils exportExcel = new ExportUtils(wb, sheet);
        ...
        exportExcel.outputExcel("G:\\拒绝件统计.xls");
