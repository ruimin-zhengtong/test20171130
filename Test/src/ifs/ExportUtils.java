 ...
 * Package ifs 
 * FileName: ExportUtils.java
 * Author:   FY
 * Date:     2017年3月22日 下午5:03:28
 * Description: //模块目的、功能描述      
 * History: //修改记录
 *===============================================================================================
 *   author：          time：                             version：           desc：
 *   FY           2017年3月22日下午5:03:28                     1.0                  
 *===============================================================================================
 */
package ifs;
...
public class ExportUtils {
     ...
     * @param sheet
     */
    public ExportUtils(HSSFWorkbook wb, HSSFSheet sheet) {
        super();
        this.wb = wb;
        this.sheet = sheet;
    }
    ...
    public void createColumHeader(String[] columHeader) {
        ...
        cellStyle.setFont(font);
        /*
         * cellStyle.setBorderBottom(HSSFCellStyle.BORDER_THIN); // 设置单无格的边框为粗体 cellStyle.setBottomBorderColor(HSSFColor.BLACK.index); // 设置单元格的边框颜色．
         * cellStyle.setBorderLeft(HSSFCellStyle.BORDER_THIN); cellStyle.setLeftBorderColor(HSSFColor.BLACK.index);
         * cellStyle.setBorderRight(HSSFCellStyle.BORDER_THIN); cellStyle.setRightBorderColor(HSSFColor.BLACK.index);
         * cellStyle.setBorderTop(HSSFCellStyle.BORDER_THIN); cellStyle.setTopBorderColor(HSSFColor.BLACK.index);
         */
        // 设置单元格背景色
...
// <%response.setCountType("application/vnd.ms-execl;charset=GBK");%>
